...
type DietaryProfileState = {
  ...
  // Consentement EXPLICITE au traitement des données de santé, horodaté. Requis
  // AVANT toute saisie d'allergène/grossesse/régime. Retiré en supprimant ses
  // profils (le retrait efface les données → cf. revokeHealthConsent).
